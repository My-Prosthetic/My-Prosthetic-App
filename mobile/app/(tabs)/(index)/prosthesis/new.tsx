...
export default function NewProsthesisScreen() {
  ...
  const [amputationLevel, setAmputationLevel] =
    useState<AmputationLevel | null>(null);

  const [replacementDate, setReplacementDate] =
    useState('');

  const [notes, setNotes] = useState('');
  const [notesHeight, setNotesHeight] =
    useState(44);
  ...
  const handleSave = () => {
    ...
    // TODO:
    // INSERT do SQLite
    // pobranie ID nowej protezy
    // przejście do ekranu "Moja Proteza"
  };
      ...
      >
        ...
        <View style={styles.section}>
          ...
          <View style={styles.iconSelector}>
            ...
            <ThemedView
              colorName="primary_base"
              style={styles.prosthesisIconCard}
            >
              <Image
        ...
        <View style={styles.section}>
          ...
          >
            <TextInput
              ...
              placeholder={t(
                'newProsthesis.replacementDatePlaceholder'
              )}
              placeholderTextColor={
                colors.primary_base
              }
        ...
        <View style={styles.section}>
          ...
          >
            <TextInput
              ...
              placeholder={t(
                'newProsthesis.notesPlaceholder'
              )}
              placeholderTextColor={
                colors.primary_base
              }
  ...
  return (
    <View style={styles.toggleRow}>
      <ThemedText
        ...
        style={[
          styles.toggleLabel,
          !value && styles.toggleLabelSelected,
        ]}
      >
        {leftLabel}
      </ThemedText>
